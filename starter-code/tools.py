...
TOOL_DEFINITIONS = [
    {
        ...
        "description": "Tra cứu sản phẩm/dịch vụ Vingroup (xe điện hoặc dịch vụ Vinpearl) theo danh mục và giá tối đa.",
        "parameters": {
            "type": "object",
            "properties": {
                "category": {
                ...
                "max_price": {
                    "type": "integer",
                    "description": "Giá tối đa tính bằng VNĐ (ví dụ: 600000000)."
                }
            },
            "required": ["category"]
        }
    },
    {
        ...
        "description": "Ghi nhận yêu cầu hỗ trợ hoặc khiếu nại của khách hàng vào hệ thống ticket.",
        "parameters": {
            "type": "object",
            "properties": {
                "customer_name": {
                ...
                "issue_description": {
                    "type": "string",
                    "description": "Mô tả chi tiết vấn đề cần hỗ trợ hoặc khiếu nại."
                },
                "priority": {
                    "type": "string",
